...
export default function Programmers() {
  ...
  const [awesomeProgrammers] = useState(listOfAwesome)
  ...
  return featured ? awesomeProgrammers[featured - 1].name : null

  };

  //console.log(awesomeProgrammers[dev.id])
